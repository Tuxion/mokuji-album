<?php namespace components\album; if(!defined('TX')) die('No direct access.');
...
class Sections extends \dependencies\BaseViews
{
  ...
  /*
    ...
    Call a section from the client-side using:
      http://mysite.com/index.php?section=album/function_name
    
    Call a section from the server-side using:
      tx('Component')->sections('album')->get_html('function_name', Data($options));
